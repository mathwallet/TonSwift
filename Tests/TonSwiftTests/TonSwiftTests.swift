...
final class TonSwiftTests: XCTestCase {
    ...
    func testTransactionExample() throws {
        do {
            ...
            let signedMessage = try contract.createSignedTransferMessagePayloadString(secretKey: keypair.secretKey, address: "EQCBlo5osdqQWEc4YRVaMB7DcP5PVm1qKknAmkttUIclyhgS", amount: BigInt("10000000"), seqno: 9, payload: "123")
