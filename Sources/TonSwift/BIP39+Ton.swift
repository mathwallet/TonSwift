...
extension BIP39 {
    static public func seedFromTonMmemonics(_ mnemonics: String, password: String = "", language: BIP39Language = BIP39Language.english) -> Data? {
        ...
        let salt = "TON seed version" + password
