...
public struct ConnectStateInit: CellCodable {
    var splitDepth: UInt32?
    var special: TickTock?
    var code: ConnectCell?
    var data: ConnectCell?
    var libraries: [UInt256: SimpleLibrary]

    init(splitDepth: UInt32? = nil,
         special: TickTock? = nil,
         code: ConnectCell? = nil,
         data: ConnectCell? = nil,
    ...
    static public func loadFrom(slice: ConnectSlice) throws -> ConnectStateInit {
        ...
        return ConnectStateInit(splitDepth: splitDepth, special: special, code: code, data: data, libraries: libraries)
    }
}
...
struct TickTock: CellCodable {
    ...
    static func loadFrom(slice: ConnectSlice) throws -> TickTock {
        return TickTock(
...
extension SimpleLibrary: CellCodable {
    ...
    public static func loadFrom(slice: ConnectSlice) throws -> SimpleLibrary {
        return Self(
